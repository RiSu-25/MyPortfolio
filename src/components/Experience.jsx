...
const experienceData = [
  {
    ...
    description:
      "Built dynamic UI with React.js & Tailwind CSS, transformed Figma designs into pixel-perfect components, utilized Git/GitHub, and enhanced frontend skills.",
  ...
  },
  {
    ...
    description:
      "Built responsive dashboards and webpages with HTML, CSS, and JavaScript while collaborating remotely during COVID-19 lockdown to gain practical frontend development experience.",
  ...
  return (
    <div id="experience" className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      <p className="text-center max-w-2xl mx-auto mt-5 mb-12">
        I have hands-on experience in frontend development, building responsive
        and user-friendly websites using React.js, Tailwind CSS, and JavaScript.
      </p>

      {/* Experience Section */}
      <h3 className="text-xl font-semibold text-center my-6 text-gray-700 underline decoration-2 underline-offset-4">
        Experience
      </h3>
      <div className="grid grid-cols-[repeat(auto-fit,_minmax(200px,_1fr))] gap-6 my-10 justify-center items-center">
        {experienceData.map((exp, index) => (
          <div
            key={index}
            className="border border-gray-400 bg-white/60 rounded-lg px-8 py-12 hover:shadow-[4px_4px_0_#000] cursor-pointer hover:bg-[#fcf4ff] hover:-translate-y-1 duration-500"
          >
            <div className="w-10">{exp.icon}</div>
            <h3 className="text-lg my-4 text-gray-700">{exp.title}</h3>
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 sm:gap-0 my-2">
